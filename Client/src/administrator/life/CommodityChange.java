...
public class CommodityChange  {
	...
	public CommodityChange(Commodity commo) {
		...
		JTextFieldGoodsNumber.setText(Integer.toString(commo.getStock()));
		...
		JTextFieldGoodsID.setEnabled(false);
		JTextFieldGoodsID.setLocation(162, 32);
		JTextFieldGoodsID.setSize(108, 34);
		JTextFieldGoodsID.setText(Integer.toString(commo.getID()));
		...
		JTextFieldGoodsPrice.setText(Double.toString(commo.getPrice()));
		...
		JTextFieldGoodsPic.setText(commo.getPicturePath());
		...
		JTextFieldGoodsContent.setText(commo.getBriefInfo());
		...
		JTextFieldGoodsName.setText(commo.getProduct());
		...
		brand.setText((String)commo.getBrand());
		BigPanel.add(brand);
		brand.setColumns(10);
